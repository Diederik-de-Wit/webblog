<div class="container mx-auto mt-2">
    ...
    <div class="flex content-center m-2 p-2">
        <x-jet-button wire:click="showCreatePostModal" class="bg-green-500 hover:bg-green-700">Create Post</x-jet-button>
    </div>
    <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
              ...
              <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                  ...
                  <td class="px-6 py-4 whitespace-nowrap">
                    ...
                    @endif</td>
                  <td class="px-6 py-4 whitespace-nowrap">
                    <img class="w-8 h-8 rounded-full" src="/uploads/images/posts/{{ $post->image }}" />
                  </td>
                  <td class="px-6 py-4 text-right text-sm">
                      <x-jet-button wire:click="showEditPostModal({{ $post->id}})" class="bg-blue-500 hover:bg-blue-700">Edit</x-jet-button>
                      <x-jet-button wire:click="deletePost({{ $post->id}})" class="bg-red-500 hover:bg-red-700">Delete</x-jet-button>
                  </td>
                </tr>
                @endforeach
                <!-- More items... -->
      ...
      <x-jet-dialog-modal wire:model="showModalForm">
                ...
                <form enctype="multipart/form-data">
                  ...
                  <div class="sm:col-span-6">
                      <div class="w-full m-2 p-2">
                        @if ($newImage)
                        Post Image:
                        <img src="/uploads/images/posts/{{ $post->image }}">
                        @endif
                        @if ($image)
                        Image Preview:
          ...
          <x-slot name="footer">
              @if($postId)
              <x-jet-button wire:click="savePost">Save Changes</x-jet-button>
              @else
              <x-jet-button wire:click="storePost">Upload</x-jet-button>
              @endif
          </x-slot>
      </x-jet-dialog-modal>
